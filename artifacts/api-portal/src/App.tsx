...
const AGENT_SETUP_PROMPT = `你的任务是从 GitHub 检出 AI 反代网关项目并完成完整部署，请按以下步骤依次执行：
...
3. curl -X POST http://localhost:8080/v1/messages -H "x-api-key: 123456" -H "Content-Type: application/json" -d '{"model":"claude-haiku-4-5","messages":[{"role":"user","content":"hi"}],"max_tokens":20}'
